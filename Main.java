            ...
            System.out.println("1.Login");
             System.out.println("2.Register");
              ...
              if(choice==1){
                 ...
                 if(currentUser==null){
                    System.out.println("Gotch You! Invalid Username or Password, Try Again");
                 }
                ...
                System.out.println("Hurrah! User Registered Successfully,Now you can Login");
              }
              else if(choice==3){
                System.out.println("GoodBye, We will Miss You!");
                return;
              }else{
                System.out.println("Invalid Choice,Get Your Eyes Tested and Try Again");
              }
        }
        System.out.println("A very Warm Welcome "+currentUser.getName());
        int choice;
        do{
          ...
          if(currentUser.getIsAdmin()){
            ...
            if(choice==1){
                ...
                System.out.println();
                System.out.println("Treasure oh Sorry! Book Added Successfully");
            }
            else if(choice==2){
                ...
                for(User u:users){
                 ...
                 System.out.println("Get Your Eyes Tested ! Invalid Choice, Try Again");
            }
            else {
